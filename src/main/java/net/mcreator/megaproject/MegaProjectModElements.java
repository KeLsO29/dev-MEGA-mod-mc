...
public class MegaProjectModElements {
	...
	public MegaProjectModElements() {
		...
		try {
			...
			for (ModFileScanData.AnnotationData annotationData : annotations) {
				if (annotationData.getAnnotationType().getClassName().equals(ModElement.Tag.class.getName())) {
					...
					if (clazz.getSuperclass() == MegaProjectModElements.ModElement.class)
						elements.add((MegaProjectModElements.ModElement) clazz.getConstructor(this.getClass()).newInstance(this));
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
		...
		elements.forEach(MegaProjectModElements.ModElement::initElements);
		MinecraftForge.EVENT_BUS.register(new MegaProjectModVariables(this));
	}
	...
	public <T> void addNetworkMessage(Class<T> messageType, BiConsumer<T, PacketBuffer> encoder, Function<PacketBuffer, T> decoder,
		...
		MegaProjectMod.PACKET_HANDLER.registerMessage(messageID, messageType, encoder, decoder, messageConsumer);
		messageID++;
	}
	...
	public static class ModElement implements Comparable<ModElement> {
		...
		protected final MegaProjectModElements elements;
		protected final int sortid;
		public ModElement(MegaProjectModElements elements, int sortid) {
