...
public class OrangeConcreteStairsBlock extends MegaProjectModElements.ModElement {
	@ObjectHolder("mega_project:orange_concrete_stairs")
	public static final Block block = null;
	public OrangeConcreteStairsBlock(MegaProjectModElements instance) {
		super(instance, 311);
	}
