...
import net.mcreator.megaproject.procedures.ConstructorinactiveUpdateTickProcedure;
...
public class ConstructorinactiveBlock extends MegaProjectModElements.ModElement {
	@ObjectHolder("mega_project:constructorinactive")
	public static final Block block = null;
	@ObjectHolder("mega_project:constructorinactive")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public ConstructorinactiveBlock(MegaProjectModElements instance) {
		super(instance, 176);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("constructorinactive"));
	}
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("constructorinactive");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				ConstructorinactiveUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, this.tickRate(world));
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("constructorinactive");
		}
