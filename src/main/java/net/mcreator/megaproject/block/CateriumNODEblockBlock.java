...
public class CateriumNODEblockBlock extends MegaProjectModElements.ModElement {
	@ObjectHolder("mega_project:caterium_nod_eblock")
	public static final Block block = null;
	public CateriumNODEblockBlock(MegaProjectModElements instance) {
		super(instance, 7);
	}
