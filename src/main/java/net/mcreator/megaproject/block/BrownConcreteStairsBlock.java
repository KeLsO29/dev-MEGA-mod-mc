...
public class BrownConcreteStairsBlock extends MegaProjectModElements.ModElement {
	@ObjectHolder("mega_project:brown_concrete_stairs")
	public static final Block block = null;
	public BrownConcreteStairsBlock(MegaProjectModElements instance) {
		super(instance, 333);
	}
