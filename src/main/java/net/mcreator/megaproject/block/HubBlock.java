...
import net.mcreator.megaproject.procedures.HubPlayerStartsToDestroyProcedure;
import net.mcreator.megaproject.procedures.HubBlockIsPlacedByProcedure;
import net.mcreator.megaproject.itemgroup.ProjectMEGAItemGroup;
import net.mcreator.megaproject.gui.HubGUIGui;
...
public class HubBlock extends MegaProjectModElements.ModElement {
	@ObjectHolder("mega_project:hub")
	public static final Block block = null;
	@ObjectHolder("mega_project:hub")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public HubBlock(MegaProjectModElements instance) {
		super(instance, 35);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(25f, 10f).lightValue(0).notSolid());
