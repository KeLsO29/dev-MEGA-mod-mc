...
import net.mcreator.megaproject.procedures.LimestoneinactiveUpdateTickProcedure;
import net.mcreator.megaproject.procedures.LimestoneinactiveBlockIsPlacedByProcedure;
...
public class LimestoneinactiveBlock extends MegaProjectModElements.ModElement {
	@ObjectHolder("mega_project:limestoneinactive")
	public static final Block block = null;
	public LimestoneinactiveBlock(MegaProjectModElements instance) {
		super(instance, 236);
	}
