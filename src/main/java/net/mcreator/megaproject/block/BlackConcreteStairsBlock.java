...
public class BlackConcreteStairsBlock extends MegaProjectModElements.ModElement {
	@ObjectHolder("mega_project:black_concrete_stairs")
	public static final Block block = null;
	public BlackConcreteStairsBlock(MegaProjectModElements instance) {
		super(instance, 339);
	}
