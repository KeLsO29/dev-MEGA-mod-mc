...
import net.mcreator.megaproject.procedures.Position1blockBlockIsPlacedByProcedure;
...
public class Position1blockBlock extends MegaProjectModElements.ModElement {
	@ObjectHolder("mega_project:position_1block")
	public static final Block block = null;
	public Position1blockBlock(MegaProjectModElements instance) {
		super(instance, 261);
	}
