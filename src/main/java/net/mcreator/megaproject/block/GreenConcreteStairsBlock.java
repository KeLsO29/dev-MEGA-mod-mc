...
public class GreenConcreteStairsBlock extends MegaProjectModElements.ModElement {
	@ObjectHolder("mega_project:green_concrete_stairs")
	public static final Block block = null;
	public GreenConcreteStairsBlock(MegaProjectModElements instance) {
		super(instance, 335);
	}
