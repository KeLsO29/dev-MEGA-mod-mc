...
public class CyanConcreteStairsBlock extends MegaProjectModElements.ModElement {
	@ObjectHolder("mega_project:cyan_concrete_stairs")
	public static final Block block = null;
	public CyanConcreteStairsBlock(MegaProjectModElements instance) {
		super(instance, 327);
	}
