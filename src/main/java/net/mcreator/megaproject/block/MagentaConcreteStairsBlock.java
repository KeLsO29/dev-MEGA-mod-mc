...
public class MagentaConcreteStairsBlock extends MegaProjectModElements.ModElement {
	@ObjectHolder("mega_project:magenta_concrete_stairs")
	public static final Block block = null;
	public MagentaConcreteStairsBlock(MegaProjectModElements instance) {
		super(instance, 313);
	}
