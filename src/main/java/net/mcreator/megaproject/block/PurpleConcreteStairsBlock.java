...
public class PurpleConcreteStairsBlock extends MegaProjectModElements.ModElement {
	@ObjectHolder("mega_project:purple_concrete_stairs")
	public static final Block block = null;
	public PurpleConcreteStairsBlock(MegaProjectModElements instance) {
		super(instance, 329);
	}
