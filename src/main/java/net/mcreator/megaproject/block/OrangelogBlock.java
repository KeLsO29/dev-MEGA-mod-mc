...
public class OrangelogBlock extends MegaProjectModElements.ModElement {
	@ObjectHolder("mega_project:orangelog")
	public static final Block block = null;
	public OrangelogBlock(MegaProjectModElements instance) {
		super(instance, 221);
	}
