...
public class RedConcreteStairsBlock extends MegaProjectModElements.ModElement {
	@ObjectHolder("mega_project:red_concrete_stairs")
	public static final Block block = null;
	public RedConcreteStairsBlock(MegaProjectModElements instance) {
		super(instance, 337);
	}
