...
public class LimeConcreteStairsBlock extends MegaProjectModElements.ModElement {
	@ObjectHolder("mega_project:lime_concrete_stairs")
	public static final Block block = null;
	public LimeConcreteStairsBlock(MegaProjectModElements instance) {
		super(instance, 319);
	}
