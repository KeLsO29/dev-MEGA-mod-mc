...
public class PinkConcreteStairsBlock extends MegaProjectModElements.ModElement {
	@ObjectHolder("mega_project:pink_concrete_stairs")
	public static final Block block = null;
	public PinkConcreteStairsBlock(MegaProjectModElements instance) {
		super(instance, 321);
	}
