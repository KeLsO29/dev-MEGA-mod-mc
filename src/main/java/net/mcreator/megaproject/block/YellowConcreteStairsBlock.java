...
public class YellowConcreteStairsBlock extends MegaProjectModElements.ModElement {
	@ObjectHolder("mega_project:yellow_concrete_stairs")
	public static final Block block = null;
	public YellowConcreteStairsBlock(MegaProjectModElements instance) {
		super(instance, 317);
	}
