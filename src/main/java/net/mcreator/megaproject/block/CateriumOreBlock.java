...
public class CateriumOreBlock extends MegaProjectModElements.ModElement {
	@ObjectHolder("mega_project:caterium_ore")
	public static final Block block = null;
	public CateriumOreBlock(MegaProjectModElements instance) {
		super(instance, 2);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("caterium_ore", "caterium_ore", blockAt -> {
