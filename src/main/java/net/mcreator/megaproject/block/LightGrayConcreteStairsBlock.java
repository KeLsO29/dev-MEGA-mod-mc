...
public class LightGrayConcreteStairsBlock extends MegaProjectModElements.ModElement {
	@ObjectHolder("mega_project:light_gray_concrete_stairs")
	public static final Block block = null;
	public LightGrayConcreteStairsBlock(MegaProjectModElements instance) {
		super(instance, 325);
	}
