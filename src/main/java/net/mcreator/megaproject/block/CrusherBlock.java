...
public class CrusherBlock extends MegaProjectModElements.ModElement {
	@ObjectHolder("mega_project:crusher")
	public static final Block block = null;
	public CrusherBlock(MegaProjectModElements instance) {
		super(instance, 300);
	}
