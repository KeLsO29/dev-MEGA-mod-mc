...
public class GrayConcreteStairsBlock extends MegaProjectModElements.ModElement {
	@ObjectHolder("mega_project:gray_concrete_stairs")
	public static final Block block = null;
	public GrayConcreteStairsBlock(MegaProjectModElements instance) {
		super(instance, 323);
	}
