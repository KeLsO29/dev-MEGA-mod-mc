...
public class WhiteConcreteStairsBlock extends MegaProjectModElements.ModElement {
	@ObjectHolder("mega_project:white_concrete_stairs")
	public static final Block block = null;
	public WhiteConcreteStairsBlock(MegaProjectModElements instance) {
		super(instance, 309);
	}
