...
public class LightBlueConcreteStairsBlock extends MegaProjectModElements.ModElement {
	@ObjectHolder("mega_project:light_blue_concrete_stairs")
	public static final Block block = null;
	public LightBlueConcreteStairsBlock(MegaProjectModElements instance) {
		super(instance, 315);
	}
