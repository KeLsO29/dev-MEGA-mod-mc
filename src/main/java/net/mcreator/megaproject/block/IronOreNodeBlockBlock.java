...
public class IronOreNodeBlockBlock extends MegaProjectModElements.ModElement {
	@ObjectHolder("mega_project:iron_ore_node_block")
	public static final Block block = null;
	public IronOreNodeBlockBlock(MegaProjectModElements instance) {
		super(instance, 10);
	}
