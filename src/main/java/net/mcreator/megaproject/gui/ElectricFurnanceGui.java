...
public class ElectricFurnanceGui extends MegaProjectModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public ElectricFurnanceGui(MegaProjectModElements instance) {
		super(instance, 121);
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("mega_project:textures/electric_furnance.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Electric Furnance", 44, 4, -16751002);
			if (GeneratorWorkingLabelProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world)))
				this.font.drawString("Working", 69, 30, -13369600);
		}
