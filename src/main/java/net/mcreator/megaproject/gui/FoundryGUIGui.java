...
public class FoundryGUIGui extends MegaProjectModElements.ModElement {

	public static HashMap guistate = new HashMap();

	private static ContainerType<GuiContainerMod> containerType = null;

	public FoundryGUIGui(MegaProjectModElements instance) {
		super(instance, 84);
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("mega_project:textures/foundry_gui.png");
