...
public class AdminMenuGui extends MegaProjectModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public AdminMenuGui(MegaProjectModElements instance) {
		super(instance, 17);
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("mega_project:textures/admin_menu.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Admin Menu", 116, 15, -10092442);
		}
