...
public class PocketchestGui extends MegaProjectModElements.ModElement {

	public static HashMap guistate = new HashMap();

	private static ContainerType<GuiContainerMod> containerType = null;

	public PocketchestGui(MegaProjectModElements instance) {
		super(instance, 195);
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("mega_project:textures/pocketchest.png");
