...
public class PresserGUIGui extends MegaProjectModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public PresserGUIGui(MegaProjectModElements instance) {
		super(instance, 99);
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("mega_project:textures/presser_gui.png");
		@Override
