...
public class IronplateItem extends MegaProjectModElements.ModElement {
	@ObjectHolder("mega_project:ironplate")
	public static final Item block = null;
	public IronplateItem(MegaProjectModElements instance) {
		super(instance, 144);
	}
