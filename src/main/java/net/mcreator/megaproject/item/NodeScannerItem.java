...
public class NodeScannerItem extends MegaProjectModElements.ModElement {
	@ObjectHolder("mega_project:node_scanner")
	public static final Item block = null;
	public NodeScannerItem(MegaProjectModElements instance) {
		super(instance, 14);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("This Scanner Scans for Material Nodes"));
		}
