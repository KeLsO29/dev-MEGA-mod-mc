...
import net.mcreator.megaproject.procedures.DiamondSteelpickaxeRightClickedOnBlockProcedure;
...
public class DiamondPickaxeMENUKeyBinding extends MegaProjectModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public DiamondPickaxeMENUKeyBinding(MegaProjectModElements instance) {
		super(instance, 170);
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.diamond_pickaxe_menu", GLFW.GLFW_KEY_B, "key.categories.gameplay");
