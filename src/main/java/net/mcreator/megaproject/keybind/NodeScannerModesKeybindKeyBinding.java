...
import net.mcreator.megaproject.procedures.NodeScannerModesKeybindOnKeyPressedProcedure;
...
public class NodeScannerModesKeybindKeyBinding extends MegaProjectModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public NodeScannerModesKeybindKeyBinding(MegaProjectModElements instance) {
		super(instance, 22);
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.node_scanner_modes_keybind", GLFW.GLFW_KEY_V, "key.categories.misc");
