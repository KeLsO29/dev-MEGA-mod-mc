...
import net.mcreator.megaproject.procedures.DSArmorkeybindOnKeyPressedProcedure;
...
public class DSArmorkeybindKeyBinding extends MegaProjectModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public DSArmorkeybindKeyBinding(MegaProjectModElements instance) {
		super(instance, 229);
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.ds_armorkeybind", GLFW.GLFW_KEY_KP_0, "key.categories.misc");
