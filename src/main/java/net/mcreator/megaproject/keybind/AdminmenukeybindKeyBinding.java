...
import net.mcreator.megaproject.procedures.AdminmenukeybindOnKeyPressedProcedure;
...
public class AdminmenukeybindKeyBinding extends MegaProjectModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public AdminmenukeybindKeyBinding(MegaProjectModElements instance) {
		super(instance, 19);
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.adminmenukeybind", GLFW.GLFW_KEY_F12, "key.categories.misc");
