...
import net.mcreator.megaproject.procedures.CopperNodeStructureAdditionalGenerationConditionProcedure;
			...
			public boolean place(IWorld world, ChunkGenerator generator, Random random, BlockPos pos, NoFeatureConfig config) {
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						int y = spawnTo.getY();
						int z = spawnTo.getZ();
						if (!CopperNodeStructureAdditionalGenerationConditionProcedure
