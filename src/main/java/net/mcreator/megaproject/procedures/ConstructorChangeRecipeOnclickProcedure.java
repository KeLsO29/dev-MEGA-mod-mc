	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				System.err.println("Failed to load dependency x for procedure ConstructorChangeRecipeOnclick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				System.err.println("Failed to load dependency y for procedure ConstructorChangeRecipeOnclick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				System.err.println("Failed to load dependency z for procedure ConstructorChangeRecipeOnclick!");
			return;
		}
		...
		if ((((new Object() {
		...
		}.getValue(new BlockPos((int) x, (int) y, (int) z), "Recipe"))).equals("Screw"))) {
		...
		}.getValue(new BlockPos((int) x, (int) y, (int) z), "Recipe"))).equals("CopperSheet"))) {
			if (!world.getWorld().isRemote) {
				BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
				TileEntity _tileEntity = world.getTileEntity(_bp);
				BlockState _bs = world.getBlockState(_bp);
		...
		}.getValue(new BlockPos((int) x, (int) y, (int) z), "Recipe"))).equals("SteelBlock"))) {
			if (!world.getWorld().isRemote) {
				BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
				TileEntity _tileEntity = world.getTileEntity(_bp);
				BlockState _bs = world.getBlockState(_bp);
		...
		}.getValue(new BlockPos((int) x, (int) y, (int) z), "Recipe"))).equals("ModularFrame"))) {
			if (!world.getWorld().isRemote) {
				BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
				TileEntity _tileEntity = world.getTileEntity(_bp);
				BlockState _bs = world.getBlockState(_bp);
		...
		}.getValue(new BlockPos((int) x, (int) y, (int) z), "Recipe"))).equals("Concrete"))) {
			if (!world.getWorld().isRemote) {
				BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
				TileEntity _tileEntity = world.getTileEntity(_bp);
				BlockState _bs = world.getBlockState(_bp);
			...
			if (!world.getWorld().isRemote) {
				...
				BlockState _bs = world.getBlockState(_bp);
				if (_tileEntity != null)
					_tileEntity.getTileData().putString("Recipe", "StoneBricks");
				world.getWorld().notifyBlockUpdate(_bp, _bs, _bs, 3);
			}
		} else {
			if (!world.getWorld().isRemote) {
