...
public class DSAoverlayslowfallingProcedure extends MegaProjectModElements.ModElement {
	...
	public static boolean executeProcedure(Map<String, Object> dependencies){
		...
		if (((((entity instanceof PlayerEntity)?((PlayerEntity)entity).inventory.armorInventory.get((int) 1):ItemStack.EMPTY).getItem() == new ItemStack(DiamondSteelArmorItem.legs, (int)(1)).getItem())&&(==(true)))) {return (true);}return (false);
