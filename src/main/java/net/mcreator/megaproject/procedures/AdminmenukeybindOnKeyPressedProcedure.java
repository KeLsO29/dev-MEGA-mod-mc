...
import net.mcreator.megaproject.gui.AdminMenuGui;
...
public class AdminmenukeybindOnKeyPressedProcedure extends MegaProjectModElements.ModElement {
	public AdminmenukeybindOnKeyPressedProcedure(MegaProjectModElements instance) {
		super(instance, 19);
	}
