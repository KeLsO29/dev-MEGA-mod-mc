...
), "Energy"))>100)==(<15000))) {if(!world.getWorld().isRemote) {
...
}world.addParticle(ParticleTypes.ENCHANTED_HIT, (x+0.5), y, (z+0.5), 0, 0.5, 0);world.addParticle(ParticleTypes.ENCHANTED_HIT, (x+0.5), y, (z+0.5), 0.7, 0.5, 0);world.addParticle(ParticleTypes.ENCHANTED_HIT, (x+0.5), y, (z+0.5), (-0.7), 0.5, 0);world.addParticle(ParticleTypes.ENCHANTED_HIT, (x+0.5), y, (z+0.5), 0, 0.5, (-0.7));world.addParticle(ParticleTypes.ENCHANTED_HIT, (x+0.5), y, (z+0.5), 0, 0.5, 0.7);}
