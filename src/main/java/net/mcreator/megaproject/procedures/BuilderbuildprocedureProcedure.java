...
double sy = 0;
double sz = 0;
if ((((((entity instanceof LivingEntity)?((LivingEntity)entity).getHeldItemMainhand():ItemStack.EMPTY)).getDamage())<745)) {        sx =(double)(-150);
for (int index0 = 0; index0<(int)(300); index0++) {        sy =(double)(-20);
for (int index1 = 0; index1<(int)(70); index1++) {        sz =(double)(-150);
for (int index2 = 0; index2<(int)(300); index2++) {if (((world.getBlockState(new BlockPos((int)(x+        (sx)
),(int)(y+        (sy)
),(int)(z+        (sz)
)))).getBlock()== BuilderPreviewblockItem.block.getDefaultState().getBlock())) {if (((entity instanceof PlayerEntity)?((PlayerEntity)entity).inventory.hasItemStack(new ItemStack(, (int)(1))):false)) {world.setBlockState(new BlockPos((int)(x+        (sx)
),(int)(y+        (sy)
),(int)(z+        (sz)
...
}.toBlock(new ItemStack(, (int)(1))))
,3);if(entity instanceof PlayerEntity) {
	ItemStack _stktoremove = new ItemStack(, (int)(1));
...
}break;}}else{if(entity instanceof PlayerEntity && !entity.world.isRemote){
