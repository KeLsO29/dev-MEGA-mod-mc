...
import net.mcreator.megaproject.block.ElectricFurnanceBlockBlock;
...
public class ElectricFunanceinactiveUpdateTickProcedure extends MegaProjectModElements.ModElement {
	public ElectricFunanceinactiveUpdateTickProcedure(MegaProjectModElements instance) {
		super(instance, 164);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				System.err.println("Failed to load dependency x for procedure ElectricFunanceinactiveUpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				System.err.println("Failed to load dependency y for procedure ElectricFunanceinactiveUpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				System.err.println("Failed to load dependency z for procedure ElectricFunanceinactiveUpdateTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				System.err.println("Failed to load dependency world for procedure ElectricFunanceinactiveUpdateTick!");
			return;
		}
		...
		if (((new Object() {
			...
			if (((((new Object() {
				...
				public ItemStack getItemStack(BlockPos pos, int sltid) {
			...
			}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (0))).getItem() == new ItemStack(CateriumOreBlock.block, (int) (1))
					.getItem())) && (((new Object() {
						public int getAmount(BlockPos pos, int sltid) {
							AtomicInteger _retval = new AtomicInteger(0);
							TileEntity _ent = world.getTileEntity(pos);
					...
					}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == new ItemStack(CateriumIngotItem.block, (int) (1))
							.getItem()))))) {
				{
					BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
					BlockState _bs = ElectricFurnanceBlockBlock.block.getDefaultState();
				...
				public ItemStack getItemStack(BlockPos pos, int sltid) {
			...
			}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (0))).getItem() == new ItemStack(CopperOreBlock.block, (int) (1))
					.getItem())) && (((new Object() {
						public int getAmount(BlockPos pos, int sltid) {
							AtomicInteger _retval = new AtomicInteger(0);
							TileEntity _ent = world.getTileEntity(pos);
					...
					}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == new ItemStack(CopperIngotItem.block, (int) (1))
							.getItem()))))) {
				{
					BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
					BlockState _bs = ElectricFurnanceBlockBlock.block.getDefaultState();
				...
				public ItemStack getItemStack(BlockPos pos, int sltid) {
					...
					}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == new ItemStack(Items.EMERALD, (int) (1))
							.getItem()))))) {
				{
					BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
					BlockState _bs = ElectricFurnanceBlockBlock.block.getDefaultState();
				...
				public ItemStack getItemStack(BlockPos pos, int sltid) {
					...
					}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == new ItemStack(Items.LAPIS_LAZULI, (int) (1))
							.getItem()))))) {
				{
					BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
					BlockState _bs = ElectricFurnanceBlockBlock.block.getDefaultState();
				...
				public ItemStack getItemStack(BlockPos pos, int sltid) {
					...
					}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == new ItemStack(Blocks.STONE, (int) (1))
							.getItem()))))) {
				{
					BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
					BlockState _bs = ElectricFurnanceBlockBlock.block.getDefaultState();
