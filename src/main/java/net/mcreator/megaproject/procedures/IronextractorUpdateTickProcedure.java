...
public class IronextractorUpdateTickProcedure extends MegaProjectModElements.ModElement {
	public IronextractorUpdateTickProcedure(MegaProjectModElements instance) {
		super(instance, 126);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				System.err.println("Failed to load dependency x for procedure IronextractorUpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				System.err.println("Failed to load dependency y for procedure IronextractorUpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				System.err.println("Failed to load dependency z for procedure IronextractorUpdateTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				System.err.println("Failed to load dependency world for procedure IronextractorUpdateTick!");
			return;
		}
		...
		if (((((new Object() {
			public double getValue(BlockPos pos, String tag) {
				...
				}.getAmount(new BlockPos((int) x, (int) y, (int) z), (int) (0))))) && ((true) == (new Object() {
