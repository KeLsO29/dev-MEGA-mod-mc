...
public class SandstoneextractorUpdateTickProcedure extends MegaProjectModElements.ModElement {

	public SandstoneextractorUpdateTickProcedure(MegaProjectModElements instance) {
		super(instance, 244);
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				System.err.println("Failed to load dependency x for procedure SandstoneextractorUpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				System.err.println("Failed to load dependency y for procedure SandstoneextractorUpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				System.err.println("Failed to load dependency z for procedure SandstoneextractorUpdateTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				System.err.println("Failed to load dependency world for procedure SandstoneextractorUpdateTick!");
			return;
		}
		...
		if (((((new Object() {
				...
				}.getValue(new BlockPos((int) x, (int) y, (int) z), "Working")) == (true)))) {
			{
				...
				if (_ent != null) {
					...
					final ItemStack _setstack = new ItemStack(Blocks.SANDSTONE, (int) (1));
